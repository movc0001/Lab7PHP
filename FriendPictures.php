<html xmlns = "http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        if (!isset($_SESSION['user'])) {
            $_SESSION['rurl'] = "FriendPictures.php?friendId=$userId";
...
//                    $selectedPicture = $selectedAlbum->getPictures()[$selectedPictureId];
        ...
        <div class="container">
            <form class="form-horizontal" method="post" id="picture-form" action="FriendPictures.php?friendId=<?php print $userId ?>">
